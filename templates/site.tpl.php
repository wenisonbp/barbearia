  ...
  <header class="masthead">
    <div class="container d-flex h-100 align-items-center">
      <div class="mx-auto text-center">
        <h1 class="mx-auto my-0 text-uppercase">Bem-vindo</h1>
        <h2 class="text-white-50 mx-auto mt-2 mb-5">A Qbarber surgiu na intenção de trazer para o público masculino todos os tipos de serviço para os cuidados com o corpo e a saúde bem na palma de sua mão. </h2>
        <a href="#" class="btn btn-primary js-scroll-trigger">Iniciar</a>
      </div>
    </div>
  </header>
      ...
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <p class="text-white-50">
            Somos um grupo de jovens desenvolvedores, em busca de inovação e conhecimento. Desenvolvemos o App Qbarber com a finalidade de oferecer ao público de maneira geral, o melhor serviço e atendimento. Com o nosso aplicativo isso tudo é possível, com apenas um clique
            voçê escolhe as melhores barbearias próxima a voçê.
            <a href="#about">Baixa o app agora mesmo</a>. Não fique de fora dessa!
          </p>
        </div>
      </div>
      <img src="/barbearia/public/img/cover.png" class="img-fluid bg-image" alt="">
    </div>
  </section>
  ...
  <section id="projects" class="projects-section bg-light">
    <div class="container">
      ...
      <div class="row align-items-center no-gutters mb-4 mb-lg-5">
        ...
        <div class="col-xl-4 col-lg-5">
          <div class="featured-text text-center text-lg-left">
            ...
            <p class="text-black-50 mb-0">Conheça nossos serviços e colaboradores, para se cadastrar é muito fácil, com apenas um clique. Venha fazer parte da nossa equipe! </p>
            <a href="/barbearia/realizar_cadastro" class="btn btn-default mt-4"><i class="fas fa-arrow-alt-circle-right"></i> IR PARA</a>
          </div>
        </div>
      </div>
      ...
      <div class="row justify-content-center no-gutters mb-5 mb-lg-0">
        <div class="col-lg-6">
          <img class="img-fluid" src="/barbearia/public/img/img7.jpg" alt="">
        </div>
        <div class="col-lg-6">
          <div class="bg-black text-center h-100 project">
            <div class="d-flex h-100">
              <div class="project-text w-100 my-auto text-center text-lg-left">
                <h4 class="text-white">Tendências</h4>
                <p class="mb-0 text-white-50">Se você estava procurando essas variações para se inspirar e levar para o seu cabeleireiro, nós fizemos uma seleção completa que vai facilitar a sua vida.</p>
      ...
      <div class="row justify-content-center no-gutters">
        <div class="col-lg-6">
          <img class="img-fluid" src="/barbearia/public/img/img6.jpg" alt="">
        </div>
        <div class="col-lg-6 order-lg-first">
          <div class="bg-black text-center h-100 project">
            <div class="d-flex h-100">
              <div class="project-text w-100 my-auto text-center text-lg-right">
                <h4 class="text-white">Qbarber</h4>
                <p class="mb-0 text-white-50">Com nosso aplicativo tudo fica mais fácil, com finalidade de oferecer a voçê o melhor serviço e atendimento. Chega de filas, agende já seu horário com App Qbarber </p>
      ...
      <div class="row">
        <div class="col-md-10 col-lg-8 mx-auto text-center">
          ...
          <form class="form-inline d-flex">
            <input type="email" class="form-control flex-fill mr-0 mr-sm-2 mb-3 mb-sm-0" id="inputEmail" placeholder="Insira o endereço de e-mail">
