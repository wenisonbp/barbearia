    ...
    <div class="servico_prestado">
        <div class="row">
            ...
            <div class="servico_prestado_detalhe col-sm-8 col-6 text-right">
                ...
                <a href="/barbearia/cliente/solicitacao/<?php echo $_SESSION['id_cliente'];?>/<?php echo $servicos_barbearia['id_barbearia'];?>/<?php echo $servicos_barbearia['id_servico'];?>" class="btn_padrao">Reservar</a>
            </div>
        </div>
    </div>
