...
<div id="login_cliente" class="row justify-content-center" style="max-width: 100%;">
    <div class="p-4 col-sm-6 col-md-4 align-self-center">
        <div class="card">
            <div class="card-body clearfix">
                <h4 class="card-title">Login Área Cliente</h4>
                <form method="post" action="">
                    <div class="form-group">
                        <label for="authLogin">E-mail</label>
                        <input type="text" class="form-control" name="usuario" id="usuario" placeholder="Informe seu E-mail">
                    </div>
                    <div class="form-group">
